...
80% 할인 코드를 사용하여 베타 시험을 응시한 응시자는 시험이 정식 출시된 이후 약 6주 후 시험 제공 업체에서 25% 할인 쿠폰을 받게 됩니다. 해당 쿠폰은 시험 제공업체에서 제공하는 것으로, 시험 등록 시 사용한 이메일 주소로 발송됩니다. 시험 출시일로부터 6주 이내에 25% 할인 쿠폰을 받지 못하신 경우에는, 시험 제공업체의 고객 지원 팀에 문의하시기 바랍니다. _이 할인은 일반적으로 모든 베타 참여자에게 제공되지 않습니다. 다른 방법으로 베타 시험 비용을 지불한 경우 25% 할인 쿠폰을 받을 수 없습니다._
<br/><br/>
<div><font color='red'><em>
참고 사항: 베타 시험을 완료하면 시험의 점수 채점 모델이 아직 마무리되지 않았기 때문에 즉시 점수를 받을 수 없습니다. <strong>전 세계적으로 시험이 치러진 이후 2-3 주 이내에 시험 점수를 확인할 수 있습니다</strong>, 시험을 치른 시점에 따라 시험에 응시한 후 최대 16주까지 소요될 수 있습니다. 이 기간 동안 베타 시험 결과를 평가하기 위한 포괄적인 프로세스가 반영됩니다. 데이터를 통계적으로 분석하여 각 질문의 성과를 평가하고 베타 시험 중 제공된 모든 메모를 읽고 평가합니다.</em></font></div>
<br/>
<div><font color='red'><em> 재채점 절차는 시험이 시작되는 날에 개시되며, 최종 점수는 약 10일 후 발표됩니다. 하지만, 결과가 발표되면 학습자는 결과를 알리는 메일을 받게 됩니다.</em></font></div>
